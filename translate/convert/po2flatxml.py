...
from translate.storage import flatxml, factory
...
class po2flatxml(object):
    ...
    def __init__(self, inputfile, outputfile, templatefile=None,
        ...
        self.source_store = factory.getobject(inputfile)
        self.target_store = flatxml.FlatXMLFile(templatefile,
                                                root_name=root,
                                                value_name=value,
                                                key_name=key,
                                                namespace=ns,
    ...
    def convert_unit(self, unit):
        ...
        target_unit = flatxml.FlatXMLUnit(source=None,
